...
**BASE = the recent deck** `skills/enablement/agents/deck/BASE-DECK.md` — mirror its 18-beat storyline + design (20×11.25). This is the trained reference; don't reinvent.
